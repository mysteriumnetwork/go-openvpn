...
PLATFORM=android
SCRIPTS=android
LIBSUFFIX=android_amd64

echo "Building for: $PLATFORM"

echo "Bootstrapping Android NDK"

$ANDROID_NDK_ROOT/build/tools/make_standalone_toolchain.py --install-dir=/usr/$ANDROID_CHAIN_AMD64 --api=21 --arch=x86_64
...
echo "******* MBEDTLS"
TARGETS=android-amd64 $O3/core/scripts/android/build-mbedtls
echo "******* LZ4"
TARGETS=android-amd64 $O3/core/scripts/android/build-lz4
popd

. core/vars/setpath
. core/vars/vars-android-amd64
